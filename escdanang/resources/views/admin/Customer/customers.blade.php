    ...
    <div class="modal-dialog"> 
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
           <form class="form-horizontal" action="{{url('admin/editCustomers')}}" method="post" id="editCustomer" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <input type="hidden" name="id_edit"  id="id_edit" value="">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" style=" width: 430px;" id="name1" name="name">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail" class="col-sm-2 control-label" style="text-align: left">Phone</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" style=" width: 430px;" id="phone1" name="phone">
                  </div>
                </div>
               <div class="form-group">
                  <label for="inputEmail" class="col-sm-2 control-label" style="text-align: left">Address</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" style=" width: 430px;" id="address1" name="address">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail" class="col-sm-2 control-label" style="text-align: left">Email</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control"  style=" width: 430px;" id="email1" name="email">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail" class="col-sm-2 control-label" style="text-align: left">Facebook</label>
                  <div class="col-sm-10">
                    <input type="url" class="form-control" style=" width: 430px;" id="facebook1" name="facebook">
                  </div>
                </div>
                </div>
...
// validate
  ...
  $('#addCustomer').validate({
    ...
    rules:{
     ...
     messages:{
      name:{
         required:'Customers name is required and cannot be empty.'
       },
       phone:{
        required:'Customers phone is required and cannot be empty.',     
      },
      address:{
        required:'Customers address is required and cannot be empty.'
      },
      email:{
        required:'Customers email is required and cannot be empty.',
